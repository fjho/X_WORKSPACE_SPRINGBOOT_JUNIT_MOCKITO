...
public class ItemControllerTest {
    ...
    //FIN necesario para hacer la prueba realizando la peticion HTTP al controlador con WebMvcTest
    ...
    //TESTS LOGICA CONTROLADOR CON PETICION HTTP
        ...
        public void testDummyItemWithWebRequest() throws Exception {
            //here we want to call to an URL /alive and expect a response "{\"id\":1,\"name\":\"Ball\",\"price\":10,\"quantity\":100}"
